...
String loginIndex = 
"<form name=loginForm>"
"<h1>" DEVICE_ID " Login</h1>"
"<input name=userid placeholder='User ID'> "
"<input name=pwd placeholder=Password type=Password> "
"<input type=submit onclick=check(this.form) class=btn value=Login>"
"<div style='color:#dedede;font-size:0.8em;'>Version: " VERSION "</div></form>"
"<script>"
"function check(form) {"
...
void otasetup(void) {
  ...
  if (!MDNS.begin(DEVICE_ID)) { //http://mydoor.local
